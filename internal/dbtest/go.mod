...
require (
	...
	github.com/uptrace/bun v0.0.0
	github.com/uptrace/bun/dbfixture v0.0.0-00010101000000-000000000000
	github.com/uptrace/bun/dialect/mysqldialect v0.0.0
	github.com/uptrace/bun/dialect/pgdialect v0.0.0
	github.com/uptrace/bun/dialect/sqlitedialect v0.0.0
	github.com/uptrace/bun/driver/pgdriver v0.0.0
	github.com/uptrace/bun/driver/sqliteshim v0.0.0-00010101000000-000000000000
